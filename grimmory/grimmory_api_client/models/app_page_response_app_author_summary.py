...
if TYPE_CHECKING:
    from ..models.app_author_summary import AppAuthorSummary


T = TypeVar("T", bound="AppPageResponseAppAuthorSummary")


@_attrs_define
class AppPageResponseAppAuthorSummary:
    """
    Attributes:
        content (list[AppAuthorSummary] | Unset):
        page (int | Unset):
        size (int | Unset):
    ...
    content: list[AppAuthorSummary] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = AppAuthorSummary.from_dict(content_item_data)
        ...
        app_page_response_app_author_summary = cls(
            content=content,
            page=page,
            size=size,
        ...
        app_page_response_app_author_summary.additional_properties = d
        return app_page_response_app_author_summary
