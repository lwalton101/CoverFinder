...
T = TypeVar("T", bound="PagedModelNotebookEntry")


@_attrs_define
class PagedModelNotebookEntry:
    """
    Attributes:
        content (list[NotebookEntry] | Unset):
        page (PageMetadata | Unset):
    """

    content: list[NotebookEntry] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = NotebookEntry.from_dict(content_item_data)
        ...
        paged_model_notebook_entry = cls(
            content=content,
            page=page,
        )

        paged_model_notebook_entry.additional_properties = d
        return paged_model_notebook_entry
