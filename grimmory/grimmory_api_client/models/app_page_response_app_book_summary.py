...
if TYPE_CHECKING:
    from ..models.app_book_summary import AppBookSummary


T = TypeVar("T", bound="AppPageResponseAppBookSummary")


@_attrs_define
class AppPageResponseAppBookSummary:
    """
    Attributes:
        content (list[AppBookSummary] | Unset):
        page (int | Unset):
        size (int | Unset):
    ...
    content: list[AppBookSummary] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = AppBookSummary.from_dict(content_item_data)
        ...
        app_page_response_app_book_summary = cls(
            content=content,
            page=page,
            size=size,
        ...
        app_page_response_app_book_summary.additional_properties = d
        return app_page_response_app_book_summary
