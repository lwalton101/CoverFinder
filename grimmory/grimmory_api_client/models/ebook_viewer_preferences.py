...
T = TypeVar("T", bound="EbookViewerPreferences")


@_attrs_define
class EbookViewerPreferences:
    """
    Attributes:
        book_id (int | Unset):
        user_id (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ebook_viewer_preferences.additional_properties = d
        return ebook_viewer_preferences
