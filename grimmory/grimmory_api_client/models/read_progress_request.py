...
T = TypeVar("T", bound="ReadProgressRequest")


@_attrs_define
class ReadProgressRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        read_progress_request.additional_properties = d
        return read_progress_request
