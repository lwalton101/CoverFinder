...
T = TypeVar("T", bound="LongestAudiobookResponse")


@_attrs_define
class LongestAudiobookResponse:
    """
    Attributes:
        book_id (int | Unset):
        title (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        longest_audiobook_response = cls(
            book_id=book_id,
            title=title,
        ...
        longest_audiobook_response.additional_properties = d
        return longest_audiobook_response
