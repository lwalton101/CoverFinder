...
if TYPE_CHECKING:
    from ..models.app_series_summary import AppSeriesSummary


T = TypeVar("T", bound="AppPageResponseAppSeriesSummary")


@_attrs_define
class AppPageResponseAppSeriesSummary:
    """
    Attributes:
        content (list[AppSeriesSummary] | Unset):
        page (int | Unset):
        size (int | Unset):
    ...
    content: list[AppSeriesSummary] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = AppSeriesSummary.from_dict(content_item_data)
        ...
        app_page_response_app_series_summary = cls(
            content=content,
            page=page,
            size=size,
        ...
        app_page_response_app_series_summary.additional_properties = d
        return app_page_response_app_series_summary
