...
if TYPE_CHECKING:
    from ..models.app_notebook_book_summary import AppNotebookBookSummary


T = TypeVar("T", bound="AppPageResponseAppNotebookBookSummary")


@_attrs_define
class AppPageResponseAppNotebookBookSummary:
    """
    Attributes:
        content (list[AppNotebookBookSummary] | Unset):
        page (int | Unset):
        size (int | Unset):
    ...
    content: list[AppNotebookBookSummary] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = AppNotebookBookSummary.from_dict(content_item_data)
        ...
        app_page_response_app_notebook_book_summary = cls(
            content=content,
            page=page,
            size=size,
        ...
        app_page_response_app_notebook_book_summary.additional_properties = d
        return app_page_response_app_notebook_book_summary
