...
T = TypeVar("T", bound="MetadataClearFlags")


@_attrs_define
class MetadataClearFlags:
    """
    Attributes:
        title (bool | Unset):
        subtitle (bool | Unset):
        ...
        tags (bool | Unset):
        cover (bool | Unset):
        audiobook_cover (bool | Unset):
        reviews (bool | Unset):
        narrator (bool | Unset):
        abridged (bool | Unset):
        age_rating (bool | Unset):
        content_rating (bool | Unset):
    """
    ...
    audiobook_cover: bool | Unset = UNSET
    reviews: bool | Unset = UNSET
    narrator: bool | Unset = UNSET
    abridged: bool | Unset = UNSET
    age_rating: bool | Unset = UNSET
    content_rating: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        audiobook_cover = self.audiobook_cover
        ...
        if audiobook_cover is not UNSET:
            field_dict["audiobookCover"] = audiobook_cover
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        audiobook_cover = d.pop("audiobookCover", UNSET)
        ...
        metadata_clear_flags.additional_properties = d
        return metadata_clear_flags
