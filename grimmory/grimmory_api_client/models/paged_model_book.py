...
T = TypeVar("T", bound="PagedModelBook")
...
class PagedModelBook:
    """
    Attributes:
        content (list[Book] | Unset):
        page (PageMetadata | Unset):
    """

    content: list[Book] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = Book.from_dict(content_item_data)
        ...
        paged_model_book = cls(
            content=content,
            page=page,
        )

        paged_model_book.additional_properties = d
        return paged_model_book
